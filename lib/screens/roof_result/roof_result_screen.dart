...
class RoofResultScreen extends StatelessWidget {
  ...
  int get _effectivePanelCount {
    if (_isDefaultMock) return panelCount;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Out of ${_formatNumber(_effectiveTotalArea)} sq.ft total roof area. The rest is safely buffered for water overheads and clear terrace access.',
              style: AppTypography.bodyMd.copyWith(
                color: AppColors.onSurfaceVariant,
                fontSize: 13,
                height: 1.35,
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          '${_effectiveCapacity.toStringAsFixed(1)} kW Peak Capacity',
                          style: AppTypography.headlineSm.copyWith(
                            fontSize: 15,
                            fontWeight: FontWeight.bold,
                            color: AppColors.primary,
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Fits $_effectivePanelCount Monocrystalline Panels',
        ...
        children: [
          ...
          Expanded(
            child: _impactCard(
              ...
              value: '₹${_formatNumber(_effectiveMonthlySavings)}',
          ...
          Expanded(
            child: _impactCard(
              icon: Icons.park,
              label: 'Carbon Value',
              value: '$_effectiveTreeOffset Trees',
